 ...
 * @param {any} cmd
 */
var mailReader = function (message, cmd) {
    const commandBuilder = require("./../../services/commandBuilder");

    if (cmd[0] === commandBuilder.build("mailReader")) {
...
// ReSharper restore InconsistentNaming
                                            ...
                                            const textMessage = getTextMessage(dom);
